...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0;">
	<tr>
        ...
        <td width="85%" class="header-gold-background header"><p><a href="//www.sdsu.edu/"><img src="images/SDSU-header.gif" alt="SDSU Home Page" width="334" height="84" border="0"></a></p></td>
	</tr>
	<tr>
		<td bgcolor="#A81933" class="black-divider header"></td>
		<td bgcolor="#D2C694" class="red-underline header"><p class="breadcrumbdark"><a href="//uco.sdsu.edu/">University of Computer Operations</a> &gt; <a href="./">Client Contract Manager</a> &gt </p></td>
	</tr>
	<tr>
